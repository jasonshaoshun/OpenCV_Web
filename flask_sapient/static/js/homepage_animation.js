...
function grow_live_frame(element_name1,text,btn){
  ...
  setTimeout(function(){
      const animate_livetitle =  document.getElementById('live_title');
      animate_livetitle.style.visibility = "visible";
      animate_livetitle.classList.remove('animated', 'zoomOut','faster');
      animate_livetitle.classList.add('animated', 'zoomIn','faster');
      const animate_live_icon =  document.getElementById('live_icon');
      animate_live_icon.style.visibility = "visible";
      animate_live_icon.classList.remove('animated', 'zoomOut','faster');
      animate_live_icon.classList.add('animated', 'zoomIn','faster');
...
function shrink_live_frame(element_name1,text,btn){
  ...
  const animate_livetitle =  document.getElementById('live_title');
  animate_livetitle.classList.remove('animated', 'zoomIn','faster');
  animate_livetitle.classList.add('animated', 'zoomOut','faster');
  const animate_live_icon =  document.getElementById('live_icon');
  animate_live_icon.classList.remove('animated', 'zoomIn','faster');
  animate_live_icon.classList.add('animated', 'zoomOut','faster');

  setTimeout(function () {
    delayed(element_name1,text,btn);
    animate_live_icon.style.visibility = "hidden";
    }, 800);
}
