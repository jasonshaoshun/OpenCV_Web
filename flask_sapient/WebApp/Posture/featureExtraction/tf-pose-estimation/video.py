...
if __name__ == '__main__':
    ...
    cam = cv2.VideoCapture('/var/www/input.mp4')
    ...
    clf = joblib.load('/var/www/sapient/Posture/featureExtraction/tf-pose-estimation/training3.pkl')
    

    output = open("/var/www/sapient/Web/output.txt","w")
    output.write('')
    output.close()

    f = open("/var/www/sapient/Web/output.txt","a+")
